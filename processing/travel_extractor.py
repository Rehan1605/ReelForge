...
def extract_travel_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "travel_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Travel", raw_json)
    except ValueError as e:
        raise ValueError(f"Travel extractor returned invalid output: {e}") from e
