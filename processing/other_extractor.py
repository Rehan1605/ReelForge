...
def extract_other_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "other_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Other", raw_json)
    except ValueError as e:
        raise ValueError(f"Other extractor returned invalid output: {e}") from e
