...
def extract_ai_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "ai_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("AI", raw_json)
    except ValueError as e:
        raise ValueError(f"AI extractor returned invalid output: {e}") from e
