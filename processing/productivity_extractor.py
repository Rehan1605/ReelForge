...
def extract_productivity_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "productivity_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Productivity", raw_json)
    except ValueError as e:
        raise ValueError(f"Productivity extractor returned invalid output: {e}") from e
