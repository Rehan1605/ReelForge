...
def extract_gym_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "gym_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Gym", raw_json)
    except ValueError as e:
        raise ValueError(f"Gym extractor returned invalid output: {e}") from e
