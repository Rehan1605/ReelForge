...
def extract_finance_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "finance_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Finance", raw_json)
    except ValueError as e:
        raise ValueError(f"Finance extractor returned invalid output: {e}") from e
