...
def extract_movies_edits_knowledge(caption, transcript, vision_analysis=None):
    prompt_path = Path(PROMPTS_DIR) / "movies_edits_extractor.txt"
    ...
    try:
        ...
        return normalize_knowledge_schema("Movies & Edits", raw_json)
    except ValueError as e:
        raise ValueError(f"Movies & Edits extractor returned invalid output: {e}") from e
